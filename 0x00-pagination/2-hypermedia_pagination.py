...
class Server:
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """ it Retrieves dataset for specific page
            - Args:
                - page: to search page
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> Dict:
        """ Returns the page data plus info to next and prev pages
            - Args:
                - page: the page to look for information
...
def index_range(page: int, page_size: int) -> Tuple[int, int]:
    """ Get the start and end indices of a dataset
        - Args:
            - page: page to look for information
            - page_size: size of each page
        - Return:
            - tuple of the start index and end index of each page
    """
